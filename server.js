...
const cuteWords = {
    ...
    animal: [
        { display: '🐼パンダ', answers: ['ぱんだ', 'パンダ', 'panda'], lv: 1 },
        { display: '🐈ねこ', answers: ['ねこ', 'ネコ', '猫', 'にゃんこ', 'cat'], lv: 1 },
        { display: '🐕いぬ', answers: ['いぬ', 'イヌ', '犬', 'わんこ', 'dog'], lv: 1 },
        { display: '🐰うさぎ', answers: ['うさぎ', 'ウサギ', '兎', 'rabbit'], lv: 2 },
        { display: '🐧ぺんぎん', answers: ['ぺんぎん', 'ペンギン', 'penguin'], lv: 2 },
        { display: '🐘ゾウ', answers: ['ぞう', 'ゾウ', '象', 'elephant'], lv: 2 },
        { display: '🦒きりん', answers: ['きりん', 'キリン', 'giraffe'], lv: 3 },
        { display: '🦁らいおん', answers: ['らいおん', 'ライオン', 'lion', 'がおー'], lv: 3 },
        { display: '🐒ごりら...じゃなくて猿', answers: ['さる', 'サル', '猿', 'さるやま', 'monkey', 'ごりら', 'ゴリラ', 'gorilla', 'うほっ', 'ウホッ'], lv: 5 },
        { display: '🦊きつね', answers: ['きつね', 'キツネ', '狐', 'fox', 'こんこん'], lv: 4 },
        { display: '🐻くま', answers: ['くま', 'クマ', '熊', 'bear'], lv: 2 },
        { display: '🐨こあら', answers: ['こあら', 'コアラ', 'koala'], lv: 3 },
        { display: '🐷ぶた', answers: ['ぶた', 'ブタ', '豚', 'pig'], lv: 2 },
        { display: '🐭ねずみ', answers: ['ねずみ', 'ネズミ', '鼠', 'mouse'], lv: 3 },
        { display: '🐯とら', answers: ['とら', 'トラ', '虎', 'tiger'], lv: 3 },
        { display: '🐮うし', answers: ['うし', 'ウシ', '牛', 'cow'], lv: 2 },
        { display: '🐴うま', answers: ['うま', 'ウマ', '馬', 'horse'], lv: 2 },
        { display: '🐸かえる', answers: ['かえる', 'カエル', '蛙', 'frog'], lv: 2 },
        { display: '🐍へび', answers: ['へび', 'ヘビ', '蛇', 'snake'], lv: 4 },
        { display: '🐬いるか', answers: ['いるか', 'イルカ', 'dolphin'], lv: 4 }
    ],
    food: [
        { display: '🍓いちご', answers: ['いちご', 'イチゴ', '苺', 'ストロベリー', 'strawberry'], lv: 1 },
        { display: '🍔ハンバーガー', answers: ['はんばーがー', 'ハンバーガー', 'ばーがー', 'バーガー', 'hamburger', 'burger'], lv: 3 },
        { display: '🍦ソフトクリーム', answers: ['そふとくりーむ', 'ソフトクリーム', 'あいす', 'アイス', 'icecream'], lv: 2 },
        { display: '🍄キノコ', answers: ['きのこ', 'キノコ', 'マッシュルーム', 'mushroom'], lv: 2 },
        { display: '🍎りんご', answers: ['りんご', 'リンゴ', '林檎', 'アップル', 'apple'], lv: 1 },
        { display: '🍑もも', answers: ['もも', 'モモ', '桃', 'ピーチ', 'peach'], lv: 3 },
        { display: '🍣すし', answers: ['すし', '寿司', 'スシ', 'おすし', 'sushi'], lv: 4 },
        { display: '🍜らーめん', answers: ['らーめん', 'ラーメン', 'ramen'], lv: 3 },
        { display: '🍰けーき', answers: ['けーき', 'ケーキ', 'cake', 'ショートケーキ'], lv: 4 },
        { display: '🥩やきにく', answers: ['やきにく', '焼肉', '肉', 'にく'], lv: 5 },
        { display: '🍕ぴざ', answers: ['ぴざ', 'ピザ', 'pizza'], lv: 3 },
        { display: '🍩どーなつ', answers: ['どーなつ', 'ドーナツ', 'donut'], lv: 2 },
        { display: '🍫ちょこ', answers: ['ちょこ', 'チョコ', 'チョコレート', 'chocolate'], lv: 3 },
        { display: '🍮ぷりん', answers: ['ぷりん', 'プリン', 'pudding'], lv: 3 },
        { display: '🍙おにぎり', answers: ['おにぎり', 'オニギリ', 'おむすび', 'riceball'], lv: 2 },
        { display: '🍛かれー', answers: ['かれー', 'カレー', 'カレーライス', 'curry'], lv: 4 },
        { display: '🍞ぱん', answers: ['ぱん', 'パン', '食パン', 'bread'], lv: 1 },
        { display: '🍳めだまやき', answers: ['めだまやき', '目玉焼き', 'フライエッグ', 'fried egg'], lv: 5 },
        { display: '🍟ふらいどぽてと', answers: ['ぽてと', 'ポテト', 'フライドポテト', 'potato'], lv: 3 },
        { display: '🍈めろん', answers: ['めろん', 'メロン', 'melon'], lv: 2 }
    ],
    daily: [
        { display: '🚗くるま', answers: ['くるま', 'クルマ', '車', 'じどうしゃ', 'car', '自動車'], lv: 1 },
        { display: '🌻ひまわり', answers: ['ひまわり', 'ヒマワリ', '向日葵', 'sunflower'], lv: 3 },
        { display: '👻おばけ', answers: ['おばけ', 'オバケ', '幽霊', 'ゆうれい', 'ghost'], lv: 2 },
        { display: '🏠いえ', answers: ['いえ', '家', 'ハウス', 'house', 'おうち'], lv: 1 },
        { display: '📱すまほ', answers: ['スマホ', 'すまほ', 'スマートフォン', '携帯', 'けいたい', 'iphone'], lv: 2 },
        { display: '🚲じてんしゃ', answers: ['じてんしゃ', '自転車', 'ちゃり', 'チャリ', 'bicycle'], lv: 4 },
        { display: '👓めがね', answers: ['めがね', 'メガネ', '眼鏡', 'めがねぇ', 'めがねっ娘', 'glasses'], lv: 3 },
        { display: '⏰めざましどけい', answers: ['めざましどけい', '目覚まし時計', '時計', 'とけい'], lv: 5 },
        { display: '🧻といれっとぺーぱー', answers: ['といれっとぺーぱー', 'トイレットペーパー', 'ペーパー'], lv: 6 },
        { display: '📺てれび', answers: ['てれび', 'テレビ', 'tv'], lv: 2 },
        { display: '💻ぱそこん', answers: ['ぱそこん', 'パソコン', 'pc'], lv: 3 },
        { display: '🛌べっど', answers: ['べっど', 'ベッド', 'ふとん', '布団', 'bed'], lv: 2 },
        { display: '🚿しゃわー', answers: ['しゃわー', 'シャワー', 'shower'], lv: 4 },
        { display: '🦷はぶらし', answers: ['はぶらし', '歯ブラシ', '歯みがき'], lv: 5 },
        { display: '🌂かさ', answers: ['かさ', '傘', 'アンブレラ', 'umbrella'], lv: 2 },
        { display: '🔑かぎ', answers: ['かぎ', '鍵', 'キー', 'key'], lv: 3 },
        { display: '👠はいひーる', answers: ['はいひーる', 'ハイヒール', 'ヒール', '靴', 'くつ'], lv: 5 },
        { display: '👗わんぴーす', answers: ['わんぴーす', 'ワンピース', 'ふく', '服'], lv: 4 },
        { display: '👜かばん', answers: ['かばん', '鞄', 'バッグ', 'カバン', 'bag'], lv: 3 },
        { display: '🧴けしょうすい', answers: ['けしょうすい', '化粧水', 'コスメ', 'スキンケア'], lv: 8 }
    ],
    yabai: [
        { display: '💩うんこ（笑）', answers: ['うんこ', 'ウンコ', 'うんち', 'ウンチ', 'poop', 'くさい', 'ぶりぶり'], lv: 1 },
        { display: '🍌バナナ（意味深）', answers: ['ばなな', 'バナナ', 'banana', '🍌', 'ちんこ', 'おてぃんてぃん'], lv: 2 },
        { display: '🍒さくらんぼ（意味深）', answers: ['さくらんぼ', 'サクランボ', 'ちぇりー', 'チェリー', 'cherry', 'たまたま'], lv: 5 },
        { display: '🍄きのこ（意味深）', answers: ['きのこ', 'キノコ', 'マッシュルーム'], lv: 6 },
        { display: '💋くちびる', answers: ['くちびる', '唇', 'キス', 'きす', 'ちゅー', 'lip', 'lips'], lv: 3 },
        { display: '👙びきに', answers: ['びきに', 'ビキニ', 'みずぎ', '水着', 'bikini'], lv: 3 },
        { display: '🩲ぱんつ', answers: ['ぱんつ', 'パンツ', 'したぎ', '下着', 'panties'], lv: 3 },
        { display: '🍆なす（意味深）', answers: ['なす', 'ナス', '茄子', 'eggplant'], lv: 6 },
        { display: '🍈メロン（意味深）', answers: ['めろん', 'メロン', 'おっぱい', '巨乳', '胸'], lv: 7 },
        { display: '🍑デカ尻', answers: ['でかしり', 'デカ尻', 'お尻', 'しり', 'butt'], lv: 6 },
        { display: '🍼哺乳瓶（バブみ）', answers: ['ほにゅうびん', '哺乳瓶', 'みるく', 'ミルク', 'ばぶ'], lv: 7 },
        { display: '🛏️ベッドイン', answers: ['べっどいん', 'ベッドイン', 'べっど', 'おとまり', 'えっち'], lv: 8 },
        { display: '🏩ラブホ', answers: ['らぶほ', 'ラブホ', 'ホテル', 'ほてる'], lv: 7 },
        { display: '⛓️手錠', answers: ['てじょう', '手錠', '拘束', 'こうそく'], lv: 9 },
        { display: '💥ムチ（SM）', answers: ['むち', 'ムチ', '鞭', 'SM'], lv: 10 },
        { display: '🕯️ロウソク', answers: ['ろうそく', 'ロウソク', '蝋燭'], lv: 8 },
        { display: '🐕首輪', answers: ['くびわ', '首輪', 'ぺっと', 'ペット'], lv: 9 },
        { display: '💄キスマーク', answers: ['きすまーく', 'キスマーク'], lv: 8 },
        { display: '📳おもちゃ（意味深）', answers: ['おもちゃ', 'ろーたー', 'ローター', 'バイブ'], lv: 12 },
        { display: '🔴テンガ', answers: ['てんが', 'テンガ', 'TENGA', 'おなほ'], lv: 13 },
        { display: '📳マッサージ機（意味深）', answers: ['まっさーじき', 'マッサージ機', 'でんま', '電マ'], lv: 13 },
        { display: '🧼ソープ', answers: ['そーぷ', 'ソープ', 'お風呂'], lv: 9 },
        { display: '👙ボディーストッキング', answers: ['ぼでぃーすとっきんぐ', 'ボディーストッキング', 'タイツ'], lv: 14 },
        { display: '🤤よだれダラダラ', answers: ['よだれ', 'ヨダレ', '涎'], lv: 8 },
        { display: '🥛怪しい液体', answers: ['あやしいえきたい', '液体', 'みるく', 'ミルク', '精液'], lv: 15 },
        { display: '🎀リボン緊縛', answers: ['りぼん', 'リボン', 'しばり', '緊縛'], lv: 14 },
        { display: '🥚ローター（卵型）', answers: ['ろーたー', 'ローター', 'おもちゃ'], lv: 14 },
        { display: '🤤涎だらだら喘ぎ顔', answers: ['あえぎがお', 'よだれ', 'あえぎ'], lv: 15 },
        { display: '🍑お尻ペンペン', answers: ['しりぺんぺん', 'しり', 'おしり'], lv: 12 },
        { display: '🧊氷攻め', answers: ['こおりぜめ', 'こおり'], lv: 16 },
        { display: '🥛顔射（！？）', answers: ['がんしゃ', 'みるく', 'しおふき'], lv: 17 },
        { display: '👄ディープキス', answers: ['でぃーぷきす', 'きす'], lv: 9 },
        { display: '🧴ローションまみれ', answers: ['ろーしょん', 'ぬるぬる'], lv: 13 },
        { display: '🛀泡風呂で密着', answers: ['あわぶろ', 'おふろ'], lv: 12 },
        { display: '👘はだけた浴衣', answers: ['ゆかた', 'はだける'], lv: 13 },
        { display: '👗透け透けワンピ', answers: ['すけすけ', 'わんぴーす'], lv: 14 },
        { display: '🥵興奮して顔真っ赤', answers: ['こうふん', 'かおまっか'], lv: 11 },
        { display: '👣足コキ', answers: ['あしこき', 'あし'], lv: 16 },
        { display: '🖐️手コキ', answers: ['てこき', 'て'], lv: 16 },
        { display: '🥧パイズリ', answers: ['ぱいずり', 'おっぱい'], lv: 17 },
        { display: '🐱クリ（意味深）', answers: ['くり', 'くりとりす'], lv: 18 },
        { display: '💎真珠（意味深）', answers: ['しんじゅ', 'しんじゅいれ', 'ぴあす'], lv: 17 },
        { display: '🔥発情期', answers: ['はつじょう', 'さかり'], lv: 14 },
        { display: '🐕‍🦺散歩（SM）', answers: ['さんぽ', 'どえむ', 'SM'], lv: 16 },
        { display: '🥛ザーメン（直球）', answers: ['ざーめん', 'えきたい', 'みるく'], lv: 18 },
        { display: '💦潮吹き', answers: ['しおふき', 'みず'], lv: 15 },
        { display: '🍑桃尻を揉む', answers: ['おしり', 'もむ', 'しり'], lv: 13 },
        { display: '🍼バブみを感じる', answers: ['まざこん', 'ばぶみ'], lv: 18 },
        { display: '👗ミニスカの中覗き', answers: ['のぞき', 'ぱんつ'], lv: 14 },
        { display: '🥵絶頂寸前', answers: ['ぜっちょう', 'いく'], lv: 15 },
        { display: '👄アゴクイ', answers: ['あごくい', 'いけめん'], lv: 11 },
        { display: '👅耳舐め', answers: ['みになめ', 'みみ'], lv: 14 },
        { display: '🚿シャワー室で二人きり', answers: ['しゃわー', 'みっちゃく'], lv: 12 },
        { display: '🖐️胸を揉む', answers: ['おっぱい', 'もむ'], lv: 14 },
        { display: '💏熱い抱擁', answers: ['はぐ', 'だきしめる'], lv: 8 },
        { display: '🥵欲求不満', answers: ['もんもん', 'したい'], lv: 15 },
        { display: '👙手ブラ', answers: ['てぶら', 'おっぱい'], lv: 15 },
        { display: '🔞バック（意味深）', answers: ['ばっく', 'うしろから', 'いぬ'], lv: 18 },
        { display: '🍑生尻', answers: ['なまじり', 'おしり', 'はだか'], lv: 16 },
        { display: '🧴ヌルヌル液体', answers: ['ぬるぬる', 'ろーしょん', 'えきたい'], lv: 15 },
        { display: '🎀亀甲縛り', answers: ['きっこうしばり', 'しばり', 'りぼん'], lv: 19 },
        { display: '🥛オトナのミルク', answers: ['おとなのみるく', 'みるく', 'せいえき'], lv: 17 },
        { display: '🩲勝負下着', answers: ['しょうぶしたぎ', 'ぱんつ', 'らんじぇりー'], lv: 12 },
        { display: '💋キスマーク', answers: ['きすまーく', 'きす'], lv: 9 },
        { display: '🤤アヘ顔Wピース', answers: ['あへがお', 'だぶるぴーす', 'ぜっちょう'], lv: 18 },
        { display: '👢ニーハイ', answers: ['にーはい', 'ぜったいりょういき'], lv: 12 },
        { display: '💦潮吹き（海水…？ｗ）', answers: ['しおふき', 'みず', 'えきたい'], lv: 16 },
        { display: '🛌ピロートーク', answers: ['ぴろーとーく', 'おはなし', 'ねごと'], lv: 17 },
        { display: '🥵絶頂！アッー！', answers: ['ぜっちょう', 'いく', 'フィニッシュ'], lv: 17 },
        { display: '👄ディープな交流', answers: ['きす', 'ちゅー', 'みっちゃく'], lv: 13 }
    ],
    situation: [
        { display: '💑デート', answers: ['でーと', 'デート', 'date'], lv: 3 },
        { display: '🛁お風呂', answers: ['おふろ', 'お風呂', 'ふろ', 'bath'], lv: 2 },
        { display: '💕壁ドン', answers: ['かべどん', '壁ドン', 'kabedon'], lv: 7 },
        { display: '🛏️添い寝', answers: ['そいね', '添い寝', 'soine'], lv: 8 },
        { display: '💋キス待ち', answers: ['きすまち', 'キス待ち', 'きす'], lv: 8 },
        { display: '💏密着', answers: ['みっちゃく', '密着', 'ぎゅー', 'ハグ'], lv: 6 },
        { display: '💰パパ活', answers: ['ぱぱかつ', 'パパ活', 'ぢぢい', 'おぢ'], isEcchi: true, lv: 15 },
        { display: '💔浮気発覚', answers: ['うわき', '浮気', 'うわきはっかく', '修羅場'], lv: 12 },
        { display: '🍻合コン', answers: ['ごうこん', '合コン', '飲み会', 'のみかい'], lv: 7 },
        { display: '👀ナンパ待ち', answers: ['なんぱ', 'ナンパ', 'ナンパ待ち', '声かけられ待ち'], lv: 13 },
        { display: '🌅朝帰り', answers: ['あさがえり', '朝帰り', '始発'], lv: 11 },
        { display: '😘キス', answers: ['きす', 'キス', 'ちゅー'], lv: 4 },
        { display: '💌告白', answers: ['こくはく', '告白', 'すき', '好き'], lv: 8 },
        { display: '💍プロポーズ', answers: ['ぷろぽーず', 'プロポーズ', '結婚', 'けっこん'], lv: 10 },
        { display: '💢喧嘩', answers: ['けんか', '喧嘩', 'ケンカ', '怒り'], lv: 7 },
        { display: '🍺酔っ払い', answers: ['よっぱらい', '酔っ払い', 'よいどれ'], lv: 9 },
        { display: '🥱サボり', answers: ['さぼり', 'サボり', 'さぼる', '休憩'], lv: 7 },
        { display: '🥺ぴえん', answers: ['ぴえん', 'ぴえん🥺', '泣く', 'なき'], lv: 5 },
        { display: '💖推し活', answers: ['おしかつ', '推し活', 'おし', '推し', 'オタク'], lv: 11 },
        { display: '📸自撮り', answers: ['じどり', '自撮り', 'せるふぃー', '盛り'], lv: 8 },
        { display: '🚿一緒にお風呂', answers: ['おふろ', '一緒にお風呂', '混浴'], isEcchi: true, lv: 12 },
        { display: '🍱あーんして', answers: ['あーん', 'あーんして', '食事'], lv: 9 },
        { display: '👔ネクタイを緩める', answers: ['ねくたい', 'ネクタイ', 'セクシー'], lv: 13 },
        { display: '🧼背中を流す', answers: ['せなか', '背中を流す', 'お風呂'], lv: 12 },
        { display: '🌅朝のひととき', answers: ['あさ', '朝', '添い寝', '朝帰り'], lv: 11 },
        { display: '🧥シャツ一枚', answers: ['しゃつ', 'シャツ', '裸シャツ'], isEcchi: true, lv: 14 },
        { display: '🚃満員電車で密着', answers: ['でんしゃ', 'みっちゃく', 'ちかん', '満員電車'], isEcchi: true, lv: 14 },
        { display: '🏫放課後の教室で…', answers: ['ほうかご', 'きょうしつ', 'ないしょ'], isEcchi: true, lv: 15 },
        { display: '🎡観覧車の頂上でキス', answers: ['かんらんしゃ', 'きす', 'でーと'], isEcchi: true, lv: 14 },
        { display: '🌙夜の公園で二人きり', answers: ['こうえん', 'よる', 'ふたりきり'], lv: 12 },
        { display: '🏢会社の給湯室で…', answers: ['きゅうとうしつ', 'かいしゃ', 'ふりん', 'ないしょ'], isEcchi: true, lv: 17 },
        { display: '👗試着室に二人で入る', answers: ['しちゃくしつ', 'ふたり', 'ないしょ'], isEcchi: true, lv: 16 },
        { display: '🏊プールサイドで休憩', answers: ['ぷーる', 'みずぎ', 'きゅうけい'], lv: 10 },
        { display: '⛺テントの中で密着', answers: ['きゃんぷ', 'みっちゃく'], isEcchi: true, lv: 14 },
        { display: '🎬映画館の後ろの席で', answers: ['えいがかん', 'ないしょ'], isEcchi: true, lv: 16 },
        { display: '🎡誰もいない遊園地', answers: ['ゆうえんち', 'ふたりきり'], lv: 13 },
        { display: '🚗車内での密会', answers: ['くるま', 'ふりん', 'でーと'], isEcchi: true, lv: 15 },
        { display: '⛩️神社でお参り（という名のデート）', answers: ['じんじゃ', 'でーと'], lv: 15 },
        { display: '🚿お風呂でマッサージ', answers: ['おふろ', 'まっさーじ'], isEcchi: true, lv: 15 },
        { display: '🛌昼からベッド', answers: ['ひるま', 'えっち'], isEcchi: true, lv: 17 }
    ],
    pose: [
        { display: '✌️ぴーす', answers: ['ぴーす', 'ピース', 'peace'], lv: 1 },
        { display: '😉ウインク', answers: ['ういんく', 'ウインク', 'wink'], lv: 4 },
        { display: '🫶ハート作る', answers: ['はーと', 'ハート', 'heart'], lv: 3 },
        { display: '🫦セクシーポーズ', answers: ['せくしー', 'セクシーポーズ', 'グラビア'], isEcchi: true, lv: 12 },
        { display: '💦アヘ顔（笑）', answers: ['あへがお', 'アヘ顔', 'ahegao'], isEcchi: true, lv: 17 },
        { display: '🦵M字開脚（ヤバ', answers: ['えむじかいきゃく', 'M字開脚', 'm字'], isEcchi: true, lv: 18 },
        { display: '👀振り向き', answers: ['ふりむき', '振り向き', 'みかえり'], lv: 7 },
        { display: '💅ギャルピース', answers: ['ぎゃるぴーす', 'ギャルピ', 'ギャル'], lv: 8 },
        { display: '🤸コマネチ', answers: ['こまねち', 'コマネチ'], lv: 12 },
        { display: '🫰指ハート', answers: ['ゆびはーと', '指ハート', 'きゅんです'], lv: 9 },
        { display: '🦢がちょーん', answers: ['がちょーん', 'ガチョーン'], lv: 15 },
        { display: '👅あっかんべー', answers: ['あっかんべー', '舌出し', 'ベロ出し'], lv: 8 },
        { display: '🥺体育座り', answers: ['たいいくずわり', '体育座り', '三角座り'], lv: 11 },
        { display: '🙇‍♀️土下座', answers: ['どげざ', '土下座', 'ごめんなさい'], lv: 10 },
        { display: '🌟ジョジョ立ち', answers: ['じょじょだち', 'ジョジョ立ち', 'ジョジョ'], lv: 16 },
        { display: '🦷シェー', answers: ['しぇー', 'シェー', 'おそ松'], lv: 15 },
        { display: '🥺ぶりっ子', answers: ['ぶりっこ', 'ぶりっ子', 'あざとい'], lv: 10 },
        { display: '🙌万歳', answers: ['ばんざい', '万歳', 'バンザイ'], lv: 5 },
        { display: '💪ガッツポーズ', answers: ['がっつぽーず', 'ガッツポーズ', 'よっしゃ'], lv: 7 },
        { display: '🐶四つん這い', answers: ['よつんばい', '四つん這い', '犬のポーズ'], isEcchi: true, lv: 13 },
        { display: '👅ペロペロ', answers: ['ぺろぺろ', '舌出し', 'ベロ出し'], isEcchi: true, lv: 12 },
        { display: '🤟内緒ポーズ', answers: ['ないしょ', 'しーっ', '秘密'], lv: 11 },
        { display: '👙胸を寄せる', answers: ['おっぱい', '胸', '寄せる', '谷間'], isEcchi: true, lv: 14 },
        { display: '🦵網タイツ', answers: ['あみたいつ', '網タイツ', '足', '脚'], isEcchi: true, lv: 14 },
        { display: '💃自撮りポーズ', answers: ['じどり', 'せるふぃー', 'もり'], lv: 9 },
        { display: '💋舌ぺろポーズ', answers: ['したぺろ', 'てへぺろ', 'べろ'], isEcchi: true, lv: 12 },
        { display: '👗スカートをめくる', answers: ['すかーと', 'ぱんつ', 'めくる'], isEcchi: true, lv: 15 },
        { display: '🤱授乳ポーズ（！？）', answers: ['じゅにゅう', 'おっぱい'], isEcchi: true, lv: 17 },
        { display: '🛌誘ってる寝ポーズ', answers: ['ねそべり', 'うわめづかい', 'ねころび'], isEcchi: true, lv: 16 },
        { display: '🦵太ももを強調', answers: ['ふともも', 'あし', 'ぜったいりょういき'], isEcchi: true, lv: 15 },
        { display: '🙆‍♀️手で胸を隠す', answers: ['てぶら', 'おっぱい', 'かくす'], isEcchi: true, lv: 15 },
        { display: '🍑Ｔバック食い込み', answers: ['ぱんつ', 'くいこみ'], isEcchi: true, lv: 18 },
        { display: '🥵欲情して腰を振る', answers: ['こしふり', 'こうふん'], isEcchi: true, lv: 19 },
        { display: '💋指を舐める', answers: ['ゆびなめ', 'せくしー'], isEcchi: true, lv: 14 },
        { display: '💦汗だくでハァハァ', answers: ['あせだく', 'いきぎれ'], isEcchi: true, lv: 16 },
        { display: '🧜‍♀️脚を絡める', answers: ['あし', 'みっちゃく'], isEcchi: true, lv: 17 }
    ],
    job: [
        { display: '👮警察官', answers: ['けいさつかん', '警察官', 'おまわりさん', '警察'], lv: 4 },
        { display: '🧑‍🚒消防士', answers: ['しょうぼうし', '消防士'], lv: 5 },
        { display: '🧑‍⚕️医者', answers: ['いしゃ', '医者', 'ドクター', 'お医者さん'], lv: 4 },
        { display: '🩺看護師', answers: ['かんごし', '看護師', 'ナース'], lv: 5 },
        { display: '👨‍✈️パイロット', answers: ['ぱいろっと', 'パイロット'], lv: 7 },
        { display: '🧑‍🏫先生', answers: ['せんせい', '先生', '教師', 'きょうし'], lv: 4 },
        { display: '🪚大工', answers: ['だいく', '大工', '大工さん'], lv: 7 },
        { display: '🧑‍🍳コック', answers: ['こっく', 'コック', 'シェフ', '料理人'], lv: 6 },
        { display: '✂️美容師', answers: ['びようし', '美容師'], lv: 8 },
        { display: '🧑‍🚀宇宙飛行士', answers: ['うちゅうひこうし', '宇宙飛行士'], lv: 10 },
        { display: '📹ユーチューバー', answers: ['ゆーちゅーばー', 'ユーチューバー', 'youtuber'], lv: 9 },
        { display: '🎤歌手', answers: ['かしゅ', '歌手', 'シンガー', 'ボーカル'], lv: 6 },
        { display: '✨アイドル', answers: ['あいどる', 'アイドル'], lv: 7 },
        { display: '⚾野球選手', answers: ['やきゅうせんしゅ', '野球選手', 'プロ野球選手'], lv: 8 },
        { display: '🕵️探偵', answers: ['たんてい', '探偵'], lv: 9 },
        { display: '💼サラリーマン', answers: ['さらりーまん', 'サラリーマン', '会社員'], lv: 9 },
        { display: '🧑‍🌾農家', answers: ['のうか', '農家', 'お百姓さん'], lv: 10 },
        { display: '🎩マジシャン', answers: ['まじしゃん', 'マジシャン', '手品師'], lv: 11 },
        { display: '✍️漫画家', answers: ['まんがか', '漫画家'], lv: 10 },
        { display: '👨‍⚖️裁判官', answers: ['さいばんかん', '裁判官', 'judge'], lv: 13 }
    ],
    vehicle: [
        { display: '🚗車', answers: ['くるま', '車', '自動車'], lv: 1 },
        { display: '🚲自転車', answers: ['じてんしゃ', '自転車', 'チャリ'], lv: 3 },
        { display: '🚃電車', answers: ['でんしゃ', '電車', '列車'], lv: 4 },
        { display: '🚅新幹線', answers: ['しんかんせん', '新幹線'], lv: 6 },
        { display: '✈️飛行機', answers: ['ひこうき', '飛行機'], lv: 5 },
        { display: '🚁ヘリコプター', answers: ['へりこぷたー', 'ヘリコプター', 'ヘリ'], lv: 8 },
        { display: '🚢船', answers: ['ふね', '船', '客船', 'ボート'], lv: 4 },
        { display: '⛵ヨット', answers: ['よっと', 'ヨット'], lv: 7 },
        { display: '🛥️潜水艦', answers: ['せんすいかん', '潜水艦'], lv: 10 },
        { display: '🚑救急車', answers: ['きゅうきゅうしゃ', '救急車'], lv: 7 },
        { display: '🚓パトカー', answers: ['ぱとかー', 'パトカー'], lv: 6 },
        { display: '🚒消防車', answers: ['しょうぼうしゃ', '消防車'], lv: 7 },
        { display: '🚜トラクター', answers: ['とらくたー', 'トラクター'], lv: 10 },
        { display: '🚚トラック', answers: ['とらっく', 'トラック'], lv: 5 },
        { display: '🚌バス', answers: ['ばす', 'バス'], lv: 2 },
        { display: '🚕タクシー', answers: ['たくしー', 'タクシー'], lv: 5 },
        { display: '🚀ロケット', answers: ['ろけっと', 'ロケット'], lv: 7 },
        { display: '🛸ＵＦＯ', answers: ['ゆーふぉー', 'うぉー', 'UFO', 'ユーフォー'], lv: 8 },
        { display: '🎈気球', answers: ['ききゅう', '気球'], lv: 9 },
        { display: '🏍️バイク', answers: ['ばいく', 'バイク', 'オートバイ'], lv: 6 }
    ],
    landmark: [
        { display: '🗼東京タワー', answers: ['とうきょうたわー', '東京タワー'], lv: 5 },
        { display: '🗼スカイツリー', answers: ['すかいつりー', 'スカイツリー', '東京スカイツリー'], lv: 8 },
        { display: '🗽自由の女神', answers: ['じゆうのめがみ', '自由の女神'], lv: 10 },
        { display: '🗼エッフェル塔', answers: ['えっふぇるとう', 'エッフェル塔'], lv: 9 },
        { display: '🏜️ピラミッド', answers: ['ぴらみっど', 'ピラミッド'], lv: 6 },
        { display: '🏢ピサの斜塔', answers: ['ぴさのしゃとう', 'ピサの斜塔'], lv: 12 },
        { display: '🦁スフィンクス', answers: ['すふぃんくす', 'スフィンクス'], lv: 13 },
        { display: '🏛️凱旋門', answers: ['がいせんもん', '凱旋門'], lv: 13 },
        { display: '🧱万里の長城', answers: ['ばんりのちょうじょう', '万里の長城'], lv: 14 },
        { display: '🎭オペラハウス', answers: ['おぺらはうす', 'オペラハウス'], lv: 14 },
        { display: '🏯大仏さん', answers: ['だいぶつ', '大仏', 'だいぶつさん', 'Buddha'], lv: 10 },
        { display: '🏟️コロッセオ', answers: ['ころっせお', 'コロッセオ'], lv: 15 },
        { display: '🕰️ビッグベン', answers: ['びっぐべん', 'ビッグベン'], lv: 13 },
        { display: '🏮雷門', answers: ['かみなりもん', '雷門', '浅草寺'], lv: 14 },
        { display: '🏯金閣寺', answers: ['きんかくじ', '金閣寺'], lv: 12 },
        { display: '🏯大阪城', answers: ['おおさかじょう', '大阪城'], lv: 13 },
        { display: '🗿モアイ像', answers: ['もあいぞう', 'モアイ像', 'モアイ'], lv: 9 },
        { display: '🏯五重塔', answers: ['ごじゅうのとう', '五重塔', 'pagoda'], lv: 14 },
        { display: '🏯姫路城', answers: ['ひめじじょう', '姫路城'], lv: 15 },
        { display: '🗿マーライオン', answers: ['まーらいおん', 'マーライオン'], lv: 16 }
    ],
    item: [
        { display: '🪥歯ブラシ', answers: ['はぶらし', '歯ブラシ'], lv: 4 },
        { display: '🧻トイレットペーパー', answers: ['といれっとぺーぱー', 'トイレットペーパー'], lv: 5 },
        { display: '🧴シャンプー', answers: ['しゃんぷー', 'シャンプー'], lv: 7 },
        { display: '✂️ハサミ', answers: ['はさみ', 'ハサミ'], lv: 3 },
        { display: '🕰️時計', answers: ['とけい', '時計'], lv: 4 },
        { display: '☂️傘', answers: ['かさ', '傘', 'アンブレラ'], lv: 3 },
        { display: '👓メガネ', answers: ['めがね', 'メガネ', '眼鏡'], lv: 2 },
        { display: '📱スマホ', answers: ['すまほ', 'スマホ', 'スマートフォン', '携帯'], lv: 2 },
        { display: '💻パソコン', answers: ['ぱそこん', 'パソコン', 'PC'], lv: 3 },
        { display: '🗑️ゴミ箱', answers: ['ごみばこ', 'ゴミ箱'], lv: 6 },
        { display: '🤧ティッシュ', answers: ['てぃっしゅ', 'ティッシュ'], lv: 7 },
        { display: '🥄スプーン', answers: ['すぷーん', 'スプーン'], lv: 5 },
        { display: '🥤コップ', answers: ['こっぷ', 'コップ', 'グラス'], lv: 4 },
        { display: '🍳フライパン', answers: ['ふらいぱん', 'フライパン'], lv: 6 },
        { display: '🔪包丁', answers: ['ほうちょう', '包丁', 'ナイフ'], lv: 7 },
        { display: '📺テレビ', answers: ['てれび', 'テレビ'], lv: 2 },
        { display: '🧺洗濯機', answers: ['せんたくき', '洗濯機'], lv: 10 },
        { display: '🧹掃除機', answers: ['そうじき', '掃除機'], lv: 11 },
        { display: '🔌コンセント', answers: ['こんせんと', 'コンセント', 'プラグ'], lv: 11 },
        { display: '🔋電池', answers: ['でんち', '電池', 'バッテリー'], lv: 9 }
    ],
    bug: [
        { display: '🦋ちょうちょ', answers: ['ちょう', 'ちょうちょ', 'チョウ', 'butterfly'], lv: 4 },
        { display: '🐝はち', answers: ['はち', 'ハチ', '蜂', 'bee'], lv: 5 },
        { display: '🐞てんとう虫', answers: ['てんとうむし', 'テントウムシ', 'てんとう虫', 'ladybug'], lv: 7 },
        { display: '🐜あり', answers: ['あり', 'アリ', 'ant'], lv: 6 },
        { display: '🕷️くも', answers: ['くも', 'クモ', '蜘蛛', 'spider'], lv: 8 },
        { display: '🦗バッタ', answers: ['ばった', 'バッタ', 'grasshopper'], lv: 9 },
        { display: '🪲カブトムシ', answers: ['かぶとむし', 'カブトムシ', 'beetle'], lv: 9 },
        { display: '🦟か（蚊）', answers: ['か', 'カ', '蚊', 'mosquito'], lv: 11 },
        { display: '🪰はえ', answers: ['はえ', 'ハエ', 'fly'], lv: 9 },
        { display: '🐛いもむし', answers: ['いもむし', 'イモムシ', 'caterpillar'], lv: 10 },
        { display: '🐌かたつむり', answers: ['かたつむり', 'カタツムリ', 'snail'], lv: 10 },
        { display: '🪳ゴキブリ（笑）', answers: ['ごきぶり', 'ゴキブリ', 'G', 'cockroach'], lv: 11 },
        { display: '🐜カマキリ', answers: ['かまきり', 'カマキリ', 'mantis'], lv: 13 },
        { display: '🦟セミ', answers: ['せみ', 'セミ', '蝉', 'cicada'], lv: 12 },
        { display: '🏮ホタル', answers: ['ほたる', 'ホタル', '蛍', 'firefly'], lv: 14 }
    ]
};
